...
for Exper_index = 1:Exper_num
    ...
    while iter <= ger
        ...
        pop_new = wolf_pop; 
%         xx  = randperm(sizepop,sizepop);
%         wolf_temp1 = wolf_pop;
%         for i=1:sizepop
%             wolf_pop(:,i) = wolf_temp1(:,xx(1,i));
%         end
        for i=1:sizepop/2
        ...
        for i=sizepop/2+1:sizepop
            ...
            wolf_one_dis =  (C1.*wolf_one - wolf_one);
...
%求20次实验平均的适应值并保存
EGWO_aver_fitness = sum(Exper_best_fitness_ger,1)/Exper_num;
save EGWO_aver_fitness.mat EGWO_aver_fitness;


%保存20组最好的适应值 画线形图
EGWO_best_fitness = Exper_best_fitness_arr;
save EGWO_best_fitness.mat  EGWO_best_fitness ;
